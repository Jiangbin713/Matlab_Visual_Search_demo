...
DESCRIPTOR_FOLDER = 'N:\×ÀÃæ\CVML\Sem1-Computer Vision and Pattern Recognition\Coursework-Nov 20 TUESDAY\descriptors';
...
queryimg=floor(rand()*NIMG);    % index of a random image
 %queryimg = 107; % for all class image test
%% (Additionally) PCA
...
title('Precision-Recall Curve of Book Class'); xlabel('Recall'); ylabel('Precision');
